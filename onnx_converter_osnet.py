...
torchreid.utils.load_pretrained_weights(model, "osnet_x0_25_msmt17_combineall_256x128_amsgrad_ep150_stp60_lr0.0015_b64_fb10_softmax_labelsmooth_flip_jitter.pth") 
...
torch.onnx.export(model, input, 'osnet_x0_25_mcmt17.onnx', verbose=False, export_params=True)
